...
@section('content')
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="{{asset('images/bg12.jpg')}}" alt="" width="1100" height="275">
      <div class="carousel-caption ">
        <p>Girl with an umbrella</p>
      </div>
    </div>
    <div class="carousel-item">
      <img src="{{asset('images/bg7.jpg')}}" alt="" width="1100" height="275">
      <div class="carousel-caption d-none d-md-block">
        <p>Shajek Vellay</p>
      </div>
    </div>
    <div class="carousel-item">
      <img src="{{asset('images/bg4.jpg')}}" alt="" width="1100" height="275">
      <div class="carousel-caption d-none d-md-block">
    ...
    <div class="row">
      <div class="col-lg-3 col-md-6 col-sm-6 col-6">
        ...
        <div class="hovereffect">
          <img class="img-responsive" src="{{asset('images/bg4.jpg')}}" alt="">
          <div class="overlay">
            <h2>Sunset</h2>
          </div>
        </div>
      ...
      <div class="col-lg-3 col-md-6 col-sm-6 col-6">
        <br>
        <div class="hovereffect">
          <img class="img-responsive" src="{{asset('images/bg5.jpg')}}" alt="">
          <div class="overlay">
            <h2>Mangrove</h2>
          </div>
        </div>
      ...
      <div class="col-lg-3 col-md-6 col-sm-6 col-6">
        <br>
        <div class="hovereffect">
          <img class="img-responsive" src="{{asset('images/bg6.jpg')}}" alt="">
          <div class="overlay">
            <h2>Sundor Ban</h2>
          </div>
        </div>
      ...
      <div class="col-lg-3 col-md-6 col-sm-6 col-6">
        <br>
        <div class="hovereffect">
          <img class="img-responsive" src="{{asset('images/bg2.jpg')}}" alt="">
          <div class="overlay">
            <h2>Kaptai Lake</h2>
          </div>
        </div>
      ...
      <br>
        <div class="hovereffect">
          <img class="img-responsive" src="{{asset('images/bg9.jpg')}}" alt="">
          <div class="overlay">
            <h2>Bangal Tiger</h2>
          </div>
        </div>
      ...
      <div class="col-lg-3 col-md-6 col-sm-6 col-6">
       <br>
        <div class="hovereffect">
          <img class="img-responsive" src="{{asset('images/bg11.jpg')}}" alt="">
          <div class="overlay">
            <h2>Bridge</h2>
          </div>
        </div>
      ...
      <div class="col-lg-3 col-md-6 col-sm-6 col-6">
       <br>
        <div class="hovereffect">
          <img class="img-responsive" src="{{asset('images/bg3.jpg')}}" alt="">
          <div class="overlay">
            <h2>Saint Martin</h2>
          </div>
        </div>
      ...
      <br>
        <div class="hovereffect">
          <img class="img-responsive" src="{{asset('images/bg1.jpg')}}" alt="">
          <div class="overlay">
            <h2>Sunam Ganj</h2>
          </div>
        </div>
...
<div class="col-md-3">
  ...
  <div class="card booking-card">
    ...
    <div class="view overlay">
      <img class="card-img-top" src="{{asset('images/bg3.jpg')}}" alt="Card image cap" height="200px">
    </div>
    <!-- Card content -->
    <div class="card-body">
      <!-- Title -->
...
<div class="col-md-3">
  ...
  <div class="card booking-card">
    <!-- Card image -->
    <div class="view overlay">
      <img class="card-img-top" src="{{asset('images/bg6.jpg')}}" alt="Card image cap" height="200px">
    </div>
    <!-- Card content -->
    <div class="card-body">
      <!-- Title -->
...
<div class="col-md-3">
  ...
  <div class="card booking-card">
    <!-- Card image -->
    <div class="view overlay">
      <img class="card-img-top" src="{{asset('images/bg7.jpg')}}" alt="Card image cap" height="200px">
    </div>
    <!-- Card content -->
    <div class="card-body">
      <!-- Title -->
...
<div class="col-md-3">
  ...
  <div class="card booking-card">
    <!-- Card image -->
    <div class="view overlay">
      <img class="card-img-top" src="{{asset('images/bg11.jpg')}}" alt="Card image cap" height="200px">
    </div>
    <!-- Card content -->
    <div class="card-body">
      <!-- Title -->
